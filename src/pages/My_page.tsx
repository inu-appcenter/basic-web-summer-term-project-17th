...
<br></br>
    <Nyang><h3>회원 정보</h3></Nyang>
    <User_list name ={"횃불이"} number="010-1234-1234" regist_date = "2025/08/05"/>
    <Nyang><h3>메뉴</h3></Nyang>
    <Box>
        <Menu_component title="회원정보 수정" text="회원정보를 수정할 수 있어요."/>
        <Menu_component title="회원 탈퇴" text="지금 떠나면 정말 아쉬워요! 정말 앱센터를 떠나시겠어요?"/>
    </Box>
        </My_page_Wrapper>
    )
}
